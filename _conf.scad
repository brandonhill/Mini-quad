...
BOOM_LENGTH_NAT =
	...
	- (
		...
		//+ FRAME_CLAMP_NUT_DIM[1] / 2
		- FRAME_CLAMP_SCREW_DIM[0] / 2
//		+ max(TOLERANCE_CLEAR, MOTOR_BUMPER_RET_THICKNESS)
	)
	;
...
FRAME_DIM = [38, 38]; // TODO: calculate from stack size?
...
BATT_MOUNT_WIDTH = FRAME_DIM[1] + FRAME_CLAMP_WIDTH * 2 - BATT_STRAP_DIM[1] * 2;
...
STRUT_LENGTH_NAT = SIZE[0] - MOTOR_MOUNT_RAD * 2;
